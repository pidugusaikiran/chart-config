...
export class ChartService {
  ...
  getChartOptions(chartType: string): any[] {
    const commonOptions: any[] = [
      ...
      { name: 'Show Labels', key: 'showLabels', type: 'boolean', default: true },
      ...
      { name: 'Show X-Axis', key: 'showXAxisLine', type: 'boolean', default: true },
      { name: 'Show Y-Axis', key: 'showYAxisLine', type: 'boolean', default: true },
      { name: 'Show X-Axis Values', key: 'showXAxisValues', type: 'boolean', default: true },
      { name: 'Show Y-Axis Values', key: 'showYAxisValues', type: 'boolean', default: true },
      { name: 'Show Tooltip', key: 'showTooltip', type: 'boolean', default: true },
